          ...
          r = (function () {
            ...
            return (
              (e.prototype.addXsrfHeader = function (e) {
                var t;
                if (this.xsrfCookieName && this.$document[0])
                  for (
                    var i = 0,
          ...
          angular
            ...
            .controller("UibTypeaheadController", [
              ...
              function (e, t, i, n, r, a, o, s, l, u, c, d, p) {
                function m() {
                  (L.moveInProgress || ((L.moveInProgress = !0), L.$digest()),
                    Y());
                }
                function h() {
                  ((L.position = S ? d.offset(t) : d.position(t)),
                          ...
                          if (a && a.length > 0) {
                            ...
                            if (
                              ...
                              E &&
                                ...
                                (function (e) {
                                  return (
                                    !!(L.matches.length > 0 && e) &&
                                    e.toUpperCase() ===
                                      L.matches[0].label.toUpperCase()
                                  );
                                })(i) &&
                                (angular.isNumber(L.debounceUpdate) ||
                                angular.isObject(L.debounceUpdate)
                                  ? c(
                                      function () {
                                        L.select(0, n);
                                      },
                ...
                var Y = c(function () {
                  (L.matches.length && h(), (L.moveInProgress = !1));
                }, 200);
                ...
                (z(),
                  ...
                  (L.select = function (n, r) {
                    var a,
                      s,
                      l = {};
                    ((M = !0),
                      (l[R.itemName] = s = L.matches[n].model),
                      (a = R.modelMapper(e, l)),
                      (function (t, i) {
                      ...
                      z(),
                      !1 !== L.$eval(i.typeaheadFocusOnSelect) &&
                        o(
                          function () {
                            t[0].focus();
                          },
                  ...
                  t.on("keydown", function (t) {
                    if (0 !== L.matches.length && -1 !== v.indexOf(t.which)) {
                      ...
                      switch ((t.preventDefault(), t.which)) {
                        ...
                        case 38:
                          ((L.activeIdx =
                            (L.activeIdx > 0 ? L.activeIdx : L.matches.length) -
                            1),
                            L.$digest(),
                  ...
                  t.on("blur", function (e) {
                    (C &&
                      ...
                      L.$apply(function () {
                        angular.isObject(L.debounceUpdate) &&
                        angular.isNumber(L.debounceUpdate.blur)
                          ? c(function () {
                              L.select(L.activeIdx, e);
                            }, L.debounceUpdate.blur)
                          : L.select(L.activeIdx, e);
                      })),
                      !w &&
                        f.$error.editable &&
                ...
                (S
                  ...
                  (this.init = function (t) {
                    ((g = (function (e) {
                      ...
                      (L.debounceUpdate = r(g.getOption("debounce"))(e)),
      ...
      7307: (e, t, i) => {
        ...
        var a = (function () {
          function e(e) {
            ...
            ((this.$injector = e),
              (this.request = function (e) {
                var i = t.$injector.get("sessionExpirationTimer");
                return -1 !== e.url.indexOf("/api/login")
                  ? (i.cancel(), e)
